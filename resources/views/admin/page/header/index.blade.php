                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    @foreach ($brand as $item)
                                        <li><a class="dropdown-item"
                                                href="{{ route('admin.header.filter', $item->name) }}">{{ $item->name }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ empty($item->image) ? '-' : asset('storage/uploads/thumbnail/' . $item->image) }}"
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.header.change_status', $item->id) }}"
        ...
        <div class="modal-dialog modal-xl" role="document" style="height: 110%;">
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-center">
                    <h5 class="modal-title" id="exampleModalScrollableTitle">Tambah Thumbnail</h5>
                </div>
